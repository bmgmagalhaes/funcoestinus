...
lista_municipios_retorno = {
    ...
    "Arez": {"ARES ARRECADAÇÃO 001BANCO DO BRASIL": ".001"},
    "Belo Jardim": {
    ...
    "Lagoa de Velhos": {"PM LAGOA VELHOS TRIB001BANCO DO BRASIL": ".001"},
    "Mamanguape": {"PMM - Tributos Munic001BANCO DO BRASIL": ".001"},
    "Ouro Branco": {"PREF MUN DE OURO BRA001BANCO DO BRASIL": ".001"},
    "Equador": {"EQUADOR - ARRECADACA001BANCO DO BRASIL": ".001"},
    "Parelhas": {
    ...
    "Lagoa Danta": {"PM DE LAGOA DANTA   104CAIXA ECON. FEDERAL": ".104"},
    "Bananeiras": {
...
def selecionar_municipio(municipio) -> dict:
    """
