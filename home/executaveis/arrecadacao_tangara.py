...
def executar_tangara(pasta_municipio):
    ...
    for arquivo in lista_arquivos:
        ...
        try:
            if 'PM DE TANGARA       104CAIXA ECON' in header:
                os.rename(caminho_completo, rf'{nome_arquivo}.104')
            elif 'PREF MUN TANGARA RN 001BANCO DO BRASIL' in header:
