...
def funcao_ajustar_relario_da_sjm(diretorio):
    ...
    with open(rf"{diretorio}\RelatorioDividaAtivaPagamento.csv", "w+") as relatorio_ajustado:
        # REFORMULANDO HEADER
        for i in header:
...
#     ajustar_relario_da_sjm(rf"c:\temp")
